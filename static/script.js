...
$(document).ready(function() {
    lines.forEach(function(line) {
        var btn = '<button type="button" id=' + encodeURIComponent(line) + ' class="btn btn-outline-dark aria-pressed="true" active"><span style="color: ' + tube_colours[line] + ';">' + line + '</span></button>';
        $('#linelist').append(btn);
    })
    $('.btn').click(function() {
        $(this).button('toggle');
